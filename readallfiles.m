...
for z = 1:2
    ...
    if z == 1
        ...
        files = dir('C:\Users\mouli\OneDrive - Michigan Medicine\Desktop\Things to Add in Dropbox\Matlab course\Course Materials\Other Programs\keypressdata\*.xlsx');
    end
    ...
    %% Save data
    headers1 = {'meanleft1','meanleftmicroonline1','meanleftmicrooffline1','meanlefttotal1','meanright1','meanrightmicroonline1','meanrightmicrooffline1','meanrighttotal1'};
    headers2 = {'semleft1','semleftmicroonline1','semleftmicrooffline1','semlefttotal1','semright1','semrightmicroonline1','semrightmicrooffline1','semrighttotal1'};
    meandata = [meanleft', meanleftmicroonline', meanleftmicrooffline', meanlefttotal', meanright', meanrightmicroonline', meanleftmicrooffline', meanlefttotal']; 
    semdata = [semleft', semleftmicroonline', semleftmicrooffline', semlefttotal', semright', semrightmicroonline', semleftmicrooffline', semlefttotal'];
    meansemdata = [meandata,semdata];
    writefile = array2table(meansemdata,'variablenames',[headers1,headers2]);
    if z == 1
        filename = 'onlinemeantappingspeedata.xlsx';
    else
        filename = 'inpersonmeantappingspeedata.xlsx';
    end
    writetable(writefile,filename);
end
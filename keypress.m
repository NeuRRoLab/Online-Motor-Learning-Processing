...
data2left = data2(data2.block_id < nblock+1,:);
data2left = data2left(data2left.correcttrial == {'True'},:);
data2right = data2(data2.block_id > nblock,:);
...
for i = 1:nblock
    ...
    blockvalueright = data2right(data2right.block_id == i+nblock,:);
    ...
    rightB1 = data2right(data2right.block_id == i+nblock,:);
    rightB2 = data2right(data2right.block_id == i+nblock+1,:);
